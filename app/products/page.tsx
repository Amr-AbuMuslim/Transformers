...
const boothTypes = [
  {
    ...
    description: "Classic U-shaped configurations perfect for interactive exhibitions",
  ...
  },
  {
    ...
    items: ["With Towers (G, P)", "With Rings (H, J)", "Octopus Booth (N)", "Free Space (O)", "Pavilion (Q)"],
...
const extras = [
  ...
  { code: "J", name: "Wooden Ring", description: "Elegant ring structure element" },
...
export default function Products() {
  return (
    <>
      ...
      <PageHeader title="Transformers Booth System" image="/complete-modular-booth-system-catalog.jpg" />
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-card rounded-lg p-8 border border-border mb-12">
            <p className="text-lg text-muted-foreground mb-4">
              Transformers offers a comprehensive range of booth types that can be mixed and matched to create the
              perfect exhibition setup. All booths include a podium and support customizable branding.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
              ...
              <div>
                <p className="text-sm text-muted-foreground mb-1">Assembly Time</p>
                <p className="font-semibold text-foreground">3-4 hours</p>
              </div>
              <div>
                <p className="text-sm text-muted-foreground mb-1">Customization</p>
                <p className="font-semibold text-foreground">Fully Custom Available</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-4 bg-card">
        <div className="max-w-6xl mx-auto">
          <SectionTitle title="Booth Types" subtitle="Choose the configuration that fits your event" />
            ...
            {boothTypes.map((type, index) => (
              ...
              >
                <div className={index % 2 === 1 ? "md:order-2" : ""}>
                  <h3 className="font-serif text-3xl font-bold text-foreground mb-3">{type.category}</h3>
      ...
      <section className="py-20 px-4 bg-background">
        <div className="max-w-6xl mx-auto">
          <SectionTitle title="Extra Elements" subtitle="Enhance your booth with premium add-ons" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            {extras.map((extra, index) => (
              ...
              >
                ...
                <h4 className="font-semibold text-foreground mb-2">{extra.name}</h4>
      ...
      <section className="py-20 px-4 bg-card">
        <div className="max-w-6xl mx-auto">
          <div className="bg-background rounded-lg p-12 border border-border text-center">
            <h2 className="font-serif text-3xl font-bold mb-4">Banners & Graphics</h2>
            <p className="text-lg text-muted-foreground mb-6">
              All booths support high-quality printed graphics and banners. Choose from single or double-print options
              for maximum branding impact. Graphics can be updated quickly and affordably for different events.
            </p>
            <div className="grid grid-cols-2 gap-4 max-w-md mx-auto">
              <div className="bg-primary rounded-lg p-4">
                <p className="font-semibold text-primary-foreground">Single Print</p>
              </div>
              <div className="bg-primary rounded-lg p-4">
                <p className="font-semibold text-primary-foreground">Double Print</p>
              </div>
            </div>
          </div>
        </div>
