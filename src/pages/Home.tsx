...
const benefits = [
  {
    ...
    title: "Eco-Friendly",
    description:
      "Reusable aluminum components with zero waste production, sustainable for the environment.",
  },
  {
    icon: Boxes,
    title: "Versatile",
    description:
      "Multiple configurations: U-shape, L-shape, towers, rings, pavilions, and free-space booths.",
  },
  {
    icon: Clock,
    title: "Fast Assembly",
    description:
      "Set up in 3-4 hours with easy dismantle, storage, and transport. No heavy tools required.",
  },
  {
    icon: DollarSign,
    title: "Cost-Effective",
    description:
      "Long-term reusable investment that reduces labor, transportation, and reinstallation costs.",
  },
];
    ...
    <>
      ...
      <section className="relative h-screen md:h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          ...
          >
            Elegant. Flexible. Eco-Friendly. Premium foldable aluminum booths
            for exhibitions, trade shows, conferences, and events.
          </motion.p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-4">
                Transformers is a modular display and booth system made from
                lightweight, foldable aluminum trusses. These components allow
                exhibitors to build various configurations quickly and with
                minimal labor.
              </p>
              <ul className="space-y-3 mb-8">
                <li className="flex gap-3 items-start">
                  ...
                  <span className="text-muted-foreground">
                    Reusable, durable, and easy to transport
                  </span>
                </li>
                <li className="flex gap-3 items-start">
                  <div className="w-2 h-2 bg-secondary rounded-full mt-2 flex-shrink-0" />
                  <span className="text-muted-foreground">
                    Supports fully customizable branding
                  </span>
                </li>
                <li className="flex gap-3 items-start">
                  <div className="w-2 h-2 bg-secondary rounded-full mt-2 flex-shrink-0" />
      ...
      <section className="py-20 px-4 bg-primary text-primary-foreground">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Let our experts create the perfect booth solution for your brand.
          </p>
          <Link
            to="/contact"
